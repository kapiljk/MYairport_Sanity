Feature: Validate the functionality of Essential Services flow
  ...
  Scenario: Verify that all functionalities are working fine in EssentialServices
    ...
    Then clicks on the favorite to add to favorites in essentials
    Then verifies the Rating Review text in the POI essentials details page
    Then verifies the Take Me There text in the POI essentials details page
    And verifies the back arrow icon in the POI essentials details page
    And clicks on the back arrow icon in the POI essentials details page
    ...
    Then verifies that it takes the user to the home page from essentials
